...
VALID = {
    ...
    "publish": True,
    "prerelease": True,
    "version_name": "0.3.0-alpha.5",
    "version_code": 12,
    "tag": "v0.3.0-alpha.5",
    "title": "ConnectX v0.3.0-alpha.5 — Unified Guarded Prerelease",
    "notes_path": "docs/releases/v0.3.0-alpha.5.md",
    "scope_path": "docs/roadmap/alpha5-scope.md",
...
class ManifestValidationTest(unittest.TestCase):
    def test_valid_manifest_emits_deterministic_asset_names(self) -> None:
        ...
        self.assertEqual(outputs["tag"], "v0.3.0-alpha.5")
        self.assertEqual(outputs["apk_asset_name"], "ConnectX-v0.3.0-alpha.5-debug.apk")
        self.assertEqual(outputs["native_asset_name"], "ConnectX-v0.3.0-alpha.5-native.zip")
...
class RepositoryConsistencyTest(unittest.TestCase):
    def _write_repo(self, root: Path, readme_version: str = "0.3.0-alpha.5") -> None:
        files = {
            "app/build.gradle.kts": 'versionCode = 12\nversionName = "0.3.0-alpha.5"\n',
            "README.md": f"## Текущая версия разработки: v{readme_version}\n",
            "CHANGELOG.md": "## [0.3.0-alpha.5]\n",
            "engine/go/bridge/session.go": 'const bridgeReleaseVersion = "0.3.0-alpha.5"\n',
            "docs/releases/v0.3.0-alpha.5.md": "notes\n",
            "docs/roadmap/alpha5-scope.md": "scope\n",
